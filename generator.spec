...
subrange 1..10 int_mem;
subrange 1..10 float_mem;
subrange 10..20 strip_pow;

string_format = float_alu : float_sfu : float_mad : int_alu : int_mad : byte_alu : loop : bbsize : seed : blockDim : gridDim : reg_distance : sm_distance : shared_mem : const_mem : int_mem : float_mem : strip_pow;
